...
public class Asteroid extends Shape {
    ...
    public void Move() {
        ...
        if (yPosition < 0) yPosition = CanvasPanel.getCanvasHeight() + CanvasPanel.getCanvasYBorder();
        if (yPosition > CanvasPanel.getCanvasHeight() + CanvasPanel.getCanvasYBorder()) yPosition = 0;
    }
